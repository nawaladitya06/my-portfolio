      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col md:flex-row items-center gap-12 md:gap-8">
        ...
        <div className="w-full md:w-1/2 space-y-6 text-center md:text-left">
          ...
          <p className="text-gray-400 text-sm md:text-base max-w-lg mx-auto md:mx-0 leading-relaxed">
            Crafting <span className="text-white font-medium">aesthetic</span> digital experiences with modern tech.
            Specializing in the MERN stack, Next.js, and mobile app development.
          </p>
